...
exports.config = {
    ...
    capabilities: [{
        ...
        'appium:platformVersion' : capabilities.LOCAL_IOS_OSVERSION,
        'appium:deviceName': capabilities.LOCAL_IOS_DEVICE_NAME,
        'appium:automationName': 'XCUITest',
        'appium:app' : capabilities.IOS_STAGING_APP_LOCATION
    }],
